...
function Chats({ filter }) {
  ...
  return (
    ...
    <div className="flex flex-col overflow-y-scroll cursor-pointer h-100">
      {/* Archived container */}
      <div className="flex justify-between items-center w-100 min-h-[55px] px-3 hover:bg-[#EDF2F7]">
        {/* Icon and text container */}
        <div className="flex justify-around items-center w-[150px]">
          {/* Icon */}
          <span className="text-lg text-[#422AFB]">
            <ImFolderDownload />
          </span>

          {/* Archived */}
          <h1 className="text-black">Archived</h1>
        </div>

        {/* Number of archived chats */}
        <p className="text-xs font-light text-[#422AFB]">7</p>
      </div>
